		...
		<form>
			<table class="table">
				<tbody>
					...
					<tr>
						<th>용도</th>
						<td class="buildType">{{consulting.buildingMethod}}</td>
					</tr>
					<tr>
						<th>부지면적</th>
					...
					<tr>
						<th>건물층수</th>
						<td class="extent">{{consulting.floor}}</td>
					</tr>
					<tr>
						<th>예상비용</th>
						<td class="extent">{{consulting.cost}}</td>
					</tr>
					<tr>
						<th>예정일</th>
						<td class="extent">{{consulting.dueDate}}</td>
					</tr>
					<tr>
						<th>추가요청사항</th>
